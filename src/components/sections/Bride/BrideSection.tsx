...
import chure from "@/assets/imageVu_Giang/chure.jpg"
import codau from "@/assets/imageVu_Giang/codau.jpg"
import default_img from "@/assets/images/placeholder.webp";
import { useState } from "react";
import { siteConfig } from "@/config/site";
export default function BrideSection() {
  const [imageSrc, setImageSrc] = useState(chure.src);
  const [imageSrc2, setImageSrc2] = useState(codau.src);
