...
import bg1 from "@/assets/imageVu_Giang/bg1.jpg";
import bg2 from "@/assets/imageVu_Giang/bg2.jpg";
import bg3 from "@/assets/imageVu_Giang/bg3.jpg";
import bg4 from "@/assets/imageVu_Giang/bg4.jpg";
import bg5 from "@/assets/imageVu_Giang/bg5.jpg";
...
export default function DesktopSidebar() {
  ...
  const [imageSrc4, setImageSrc4] = useState(bg4.src);
  const [imageSrc5, setImageSrc5] = useState(bg5.src);
          ...
          <div className="position-relative overflow-hidden vw-100">
            ...
            >
              <img
                ...
                style={{ maskImage: "none", opacity: "65%", objectPosition: "center 15%" }}
              />
            </div>
            <div
            ...
            >
              <img
                ...
                alt="bg"
                className="bg-cover-home"
                style={{ maskImage: "none", opacity: "65%", objectPosition: "center 25%" }}
              />
            </div>
            <div
            ...
            <div
              className={`position-absolute h-100 w-100 slide-desktop ${activeIndex === 3 ? "slide-desktop-active" : ""}`}
              style={{ opacity: activeIndex === 3 ? 1 : 0, transition: "opacity 1.5s ease-in-out, transform 10s linear" }}
            >
              <img
                src={imageSrc4}
                onError={() => setImageSrc4(default_img.src)}
                alt="bg"
                className="bg-cover-home"
                style={{ maskImage: "none", opacity: "65%", objectPosition: "center 40%" }}
              />
            </div>
            <div
              className={`position-absolute h-100 w-100 slide-desktop ${activeIndex === 4 ? "slide-desktop-active" : ""}`}
              style={{ opacity: activeIndex === 4 ? 1 : 0, transition: "opacity 1.5s ease-in-out, transform 10s linear" }}
            >
              <img
                src={imageSrc5}
                onError={() => setImageSrc5(default_img.src)}
                alt="bg"
                className="bg-cover-home"
                style={{ maskImage: "none", opacity: "65%", objectPosition: "center 30%" }}
              />
            </div>
          </div>
        </div>
